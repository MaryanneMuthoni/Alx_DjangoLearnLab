...
This project is about Django, one of the most popular web frameworks for building robust web applications. 
It involves: setting up a Django development environment, learning about Django models and ORM, and exploring the Django admin interface.
...
4. Familiarize yourself with the created project structure. Pay particular attention to:
...
1. title: CharField with a maximum length of 200 characters.
2. author: CharField with a maximum length of 100 characters.
3. publication_year: IntegerField.
...
2. Retrieve the book you created.
3. Update the title of the created book.
